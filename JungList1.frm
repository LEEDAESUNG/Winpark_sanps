...
'Record_Source = "SELECT * FROM regcar WHERE 종료일 >= '" & Format(Now, "yyyy-mm-dd") & "'" & Order$
...
End If
LblRecordCount.Caption = "등록차량 : " & Adodc1.Recordset.RecordCount & " 대"
End Sub
...
Private Sub Command1_Click()
 ...
 'SelectionFormula$ = "{regcar.종료일} >= '" & Format(Now, "yyyy-mm-dd") & "'"
 DoEvents
 ...
 Select Case Combo1.ListIndex
        ...
        Case 3
             '성훈
             'Report1.SortFields(0) = "+{regcar.소속}"
             Report1.SortFields(0) = "+{regcar.종료일}"
 End Select
