...
Begin VB.Form T_Sail 
   ...
   Begin MSDBGrid.DBGrid DBGrid1 
      Bindings        =   "T_Sail.frx":0014
      Height          =   12900
      Left            =   135
      OleObjectBlob   =   "T_Sail.frx":0028
      TabIndex        =   10
      Top             =   540
      Width           =   18960
   End
End
Attribute VB_Name = "T_Sail"
...
Data1.RecordSource = "SELECT * FROM after-money WHERE (거래일자>='" & Format(DTPicker1.Value, "yymmdd") & "') AND (거래일자<='" & Format(DTPicker2.Value, "yymmdd") & "') ORDER BY 거래시간"
Data1.Refresh
...
Record_Source = "SELECT * FROM after-money WHERE 거래일자 = '" & Format(Now, "yymmdd") & "' ORDER BY 거래시간"
