...
Dim m_TagNum As String

Public Property Get TagNum() As String
    TagNum = m_TagNum
End Property

Public Property Let TagNum(ByVal New_TagNum As String)
    m_TagNum = New_TagNum
    PropertyChanged "TagNum"
End Property
...
Public Property Let ForeColor(ByVal New_ForeColor As OLE_COLOR)
    Frame1.ForeColor = New_ForeColor
...
Frame1.ForeColor = m_def_ForeColor
Frame1.Caption = "Connect"
...
Private Sub UserControl_ReadProperties(PropBag As PropertyBag)
    Frame1.ForeColor = PropBag.ReadProperty("ForeColor", m_def_ForeColor)
    Frame1.Caption = PropBag.ReadProperty("Caption", "")
...
Private Sub UserControl_WriteProperties(PropBag As PropertyBag)
    Call PropBag.WriteProperty("Caption", Frame1.Caption, "")
    Call PropBag.WriteProperty("ForeColor", Frame1.ForeColor, m_def_ForeColor)
