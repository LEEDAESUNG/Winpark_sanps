...
Begin VB.Form T_Disc 
   ...
   Begin MSDBGrid.DBGrid DBGrid1 
      Bindings        =   "T_Disc.frx":0014
      Height          =   9000
      Left            =   135
      OleObjectBlob   =   "T_Disc.frx":0028
      TabIndex        =   10
      Top             =   540
      Width           =   14925
   End
End
Attribute VB_Name = "T_Disc"
...
Data1.RecordSource = "SELECT * FROM tmoneyrec WHERE (인증일시>='" & Format(DTPicker1.Value, "yyyy-mm-dd") & " 00:00:01" & "') AND (인증일시<='" & Format(DTPicker2.Value, "yyyy-mm-dd") & " 23:59:59') ORDER BY 인증일시"
Data1.Refresh
...
Record_Source = "SELECT * FROM tmoneyrec WHERE (인증일시 >= '" & Format(Now, "yyyy-mm-dd 00:00:01") & "') AND (인증일시 <= '" & Format(Now, "yyyy-mm-dd 23:59:59") & "') ORDER BY 인증일시"
